...
#import "CollectionViewBigLayout.h"
...
- (UICollectionViewController *)nextViewControllerAtPoint:(CGPoint)point
{
    ...
    CollectionViewBigLayout *largeLayout = [[CollectionViewBigLayout alloc] init];
    CollectionViewControllerClass *nextCollectionViewController = [[CollectionViewControllerClass alloc] initWithCollectionViewLayout:largeLayout];
